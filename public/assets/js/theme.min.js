...
APP.colorModes = {
    ...
    colorModes: function () {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', setupLightMode);
        } else {
            setupLightMode();
        }
        
       
        window.addEventListener('load', setupLightMode);
        ...
        function setupLightMode() {
            ...
            if (themeButtons.length) {
                ...
                if (lightButton) {
                    ...
                    if (activeIcon && lightButton.querySelector('svg use')) {
                        const lightIcon = lightButton.querySelector('svg use').getAttribute('href');
                        activeIcon.setAttribute('href', lightIcon);
                    }
                }
            }
