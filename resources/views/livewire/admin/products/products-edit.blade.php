...
<!-- Add this after Category dropdown in your edit blade -->
                                                ...
                                                <div class="card-header bg-light py-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            @if (!empty($combination['variant_id']))
                                                                <button type="button"
                                                                    wire:click="deleteVariantCombination({{ $index }})"
                                                                    wire:confirm="Are you sure you want to delete this variant combination? This will permanently delete the product variant."
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 mt-3">
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                id="edit-variant-images-{{ $index }}"
                                                                class="form-control" accept="image/jpeg,image/jpg,image/png,image/gif,image/webp" multiple
                                                                onchange="ImagePreviewer.previewMultiple('edit-variant-images-{{ $index }}', 'edit-variant-container-{{ $index }}')"
                                                                wire:ignore>

                                                            <div id="edit-variant-container-{{ $index }}" class="row mt-3" wire:ignore>
                                ...
                                <div class="card-body p-7">
                                    <div class="position-relative text-center">
                                        ...
                                        <input type="file" wire:model="thumbnail_image" 
                                            ...
                                            class="form-control" 
                                            accept="image/*" 
                                            onchange="ImagePreviewer.previewSingle('edit-thumbnail-input', 'edit-thumbnail-preview', 'edit-thumbnail-remove')"
                                            wire:ignore>
                                        ...
                                        <button type="button" 
                                            ...
                                            onclick="ImagePreviewer.removeSingle('edit-thumbnail-input', 'edit-thumbnail-preview', 'edit-thumbnail-remove', 'thumbnail_image')"
                                            wire:ignore>
                                            ×
                                        </button>
                                    </div>
                                ...
                                <div class="card-body p-7">
                                    ...
                                    <div>
                                        ...
                                        <input type="file" 
                                            ...
                                            class="form-control" 
                                            onchange="ImagePreviewer.previewMultiple('edit-gallery-input', 'edit-gallery-container')"
                                            wire:ignore>

                                        <div id="edit-gallery-container" class="row mt-3" wire:ignore>
                                            <!-- Preview images will be inserted here -->
                                        </div>
                                    </div>
                                </div>
