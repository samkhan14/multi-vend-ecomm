        ...
        <div class="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 mb-4">
            ...
            <div class="product-card__thumb rounded-8 bg-gray-50 position-relative" style="height: 280px; overflow: hidden;">
                ...
                <div class="position-absolute top-0 start-0 mt-16 ms-16 z-1 d-flex flex-column gap-8">
                    ...
                    {{-- Glasses Badge --}}
                    @if($isNormalGlasses)
                        <span class="text-primary w-40 h-40 d-flex justify-content-center align-items-center bg-white rounded-circle shadow-sm text-xs fw-semibold"
                ...
                <div class="position-absolute top-0 end-0 mt-16 me-16 z-1 d-flex flex-column gap-8">
                    ...
                    <!-- Quick View Button -->
                    <button type="button" 
                            class="w-40 h-40 d-flex justify-content-center align-items-center bg-white rounded-circle shadow-sm text-neutral-600 hover-bg-main-two-600 hover-text-white border-0 quick-view-btn" 
                            data-id="{{ $product->id }}"
                ...
                <div class="countdown position-absolute start-50 translate-middle-x bottom-0 mb-20 w-100" 
                    ...
                    <ul class="countdown-list style-four d-flex justify-content-center flex-wrap gap-8">
                        <li style="width: 50px!important; height: auto;" class="countdown-list__item d-flex flex-column align-items-center text-sm fw-medium text-white rounded-lg bg-neutral-600 px-3 py-2">
            ...
            <div class="product-card__content w-100">
                <!-- Product Title -->
                <h6 class="title text-lg fw-semibold" style="margin-top: -5px !important;">
                ...
                <!-- Rating Stars -->
                <div class="d-flex align-items-center gap-6" style="margin-top: -24px !important;">
